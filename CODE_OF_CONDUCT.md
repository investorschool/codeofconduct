# Investor School Community  
# Code of Conduct

## Our Community

Investor School is a community of startup investors--originally stemming from YC Startup Investor School. We maintain an online social networks and host regular events in the Bay Area. The community is not affiliated with YCombinator.  

The group is maintained by Brad Flora (YC S11), Tim Suzman (YC S11), and Judy Yang.
...
This Code of Conduct applies both within group spaces and in public spaces when an individual is representing the project or its community. Examples of representing a project or community include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event. Representation of a project may be further defined and clarified by group maintainers.
